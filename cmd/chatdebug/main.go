...
import (
	...
	chat "github.com/openchatproject/openchat/app"
...
func init() {
	...
	config.SetBech32PrefixForAccount(chat.Bech32PrefixAccAddr, chat.Bech32PrefixAccPub)
	config.SetBech32PrefixForValidator(chat.Bech32PrefixValAddr, chat.Bech32PrefixValPub)
	config.SetBech32PrefixForConsensusNode(chat.Bech32PrefixConsAddr, chat.Bech32PrefixConsPub)
	config.Seal()
...
var rootCmd = &cobra.Command{
	Use:          "chatdebug",
	Short:        "OpenChat debug tool",
	SilenceUsage: true,
}

var txCmd = &cobra.Command{
	Use:   "tx",
	Short: "Decode a chat tx from hex or base64",
	RunE:  runTxCmd,
}
