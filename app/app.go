...
const (
	...
	DemoAddress1="chat1yt75t5f8n7dgl5eqhqfwuqda7cp7ke75llnmps"
	DemoAddress2="chat1djenv9ka38lg58dyhzypcczla0vxhr73ycwrrt"
)

var (
	// default home directories for chatcli
	DefaultCLIHome  = os.ExpandEnv("$HOME/.chatcli")
	// default home directories for chatd
	DefaultNodeHome = os.ExpandEnv("$HOME/.chatd")
)
...
// NewChatApp returns a reference to an initialized ChatApp.
func NewChatApp(logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool,
	invCheckPeriod uint, baseAppOptions ...func(*bam.BaseApp)) *ChatApp {
...
func RegistDenom() {
	_ = sdk.RegisterDenom(chat.ChatDenom, chat.ChatUnit)
	_ = sdk.RegisterDenom(chat.MicroChatDenom, chat.MicroChatUnit)
}

// application updates every end block
func (app *ChatApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
...
// application updates every end block
// nolint: unparam
func (app *ChatApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
...
func (app *ChatApp) initFromGenesisState(ctx sdk.Context, genesisState GenesisState) []abci.ValidatorUpdate {
	...
	if err := ChatValidateGenesisState(genesisState); err != nil {
		panic(err) // TODO find a way to do this w/o panics
	}
...
// custom logic for openchat initialization
func (app *ChatApp) initChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *ChatApp) LoadHeight(height int64) error {
