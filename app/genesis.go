...
var (
	...
	defaultBondDenom = chat.MicroChatDenom
)
...
// Create the core parameters for genesis initialization for openchat
// note that the pubkey input is this machines pubkey
func ChatAppGenState(cdc *codec.Codec, genDoc tmtypes.GenesisDoc, appGenTxs []json.RawMessage) (
...
// NewDefaultGenesisState generates the default state for openchat.
func NewDefaultGenesisState() GenesisState {
	...
	appGenState.MintData.Params.MintDenom = chat.MicroChatDenom
	appGenState.MintData.Params.InflationRateChange = appGenState.MintData.Params.InflationMin
	appGenState.StakingData.Params.BondDenom = chat.MicroChatDenom
	appGenState.StakingData.Params.BondDenom = chat.MicroChatDenom
	appGenState.GovData.DepositParams.MinDeposit = sdk.Coins{sdk.NewCoin(chat.MicroChatDenom, sdk.TokensFromTendermintPower(10))}
	appGenState.CrisisData.ConstantFee = sdk.NewCoin(chat.MicroChatDenom, sdk.TokensFromTendermintPower(100))

	return appGenState
}

// ChatValidateGenesisState ensures that the genesis state obeys the expected invariants
// TODO: No validators are both bonded and jailed (#2088)
// TODO: Error if there is a duplicate validator (#1708)
// TODO: Ensure all state machine parameters are in genesis (#1704)
func ChatValidateGenesisState(genesisState GenesisState) error {
...
// ChatAppGenState but with JSON
func ChatAppGenStateJSON(cdc *codec.Codec, genDoc tmtypes.GenesisDoc, appGenTxs []json.RawMessage) (
	appState json.RawMessage, err error) {
	// create the final app state
	genesisState, err := ChatAppGenState(cdc, genDoc, appGenTxs)
	if err != nil {
		return nil, err
	}
