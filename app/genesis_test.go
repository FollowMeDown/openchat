...
func TestChatAppGenTx(t *testing.T) {
	cdc := MakeCodec()
	_ = cdc
...
func TestChatAppGenState(t *testing.T) {
	cdc := MakeCodec()
	_ = cdc
	var genDoc tmtypes.GenesisDoc

	// test unmarshalling error
	_, err := ChatAppGenState(cdc, genDoc, []json.RawMessage{})
	require.Error(t, err)
...
func TestChatGenesisValidation(t *testing.T) {
	...
	err := ChatValidateGenesisState(genesisState)
	require.Error(t, err)
...
func TestGenesisStateSanitize(t *testing.T) {
	...
	require.Nil(t, ChatValidateGenesisState(genesisState))
